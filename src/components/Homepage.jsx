          ...
          <div style={{ display: "flex", justifyContent: "center", gap: "25px", flexWrap: "wrap", width: "100%" }}>
            ...
            <div 
              ...
              onClick={() => setSelectedImg({
                src: "https://media.discordapp.net/attachments/1255208300006477844/1304887641098944592/20241110021346_1.jpg?ex=6a514551&is=6a4ff3d1&hm=9953e3c50d871b3fb82fec45a7583adb37d7e4872631cd57d3cc898dfa3e1c79&=&format=webp&width=1421&height=800",
                title: "RIVERRA ASSEMBLY",
                cat: "FAMILY VISIT"
              })}
            >
              <img src="https://media.discordapp.net/attachments/1255208300006477844/1304887641098944592/20241110021346_1.jpg?ex=6a514551&is=6a4ff3d1&hm=9953e3c50d871b3fb82fec45a7583adb37d7e4872631cd57d3cc898dfa3e1c79&=&format=webp&width=1421&height=800" alt="Riverra Action" />
            ...
            <div 
              ...
              style={{ flex: "1 1 240px", maxWidth: "280px", cursor: "pointer" }}
              onClick={() => setSelectedImg({
                src: "https://media.discordapp.net/attachments/1521207921227075796/1523315455693951097/image.png?ex=6a519852&is=6a5046d2&hm=d65cc4dc57feb6f05ffbe586cf2a4ce08ab87018bbbb353024f8485510b183ce&=&format=webp&quality=lossless&width=1424&height=800",
                title: "FAMILY GATHERING",
                cat: "TOGETHER AS ONE"
              })}
            >
              <img src="https://media.discordapp.net/attachments/1521207921227075796/1523315455693951097/image.png?ex=6a519852&is=6a5046d2&hm=d65cc4dc57feb6f05ffbe586cf2a4ce08ab87018bbbb353024f8485510b183ce&=&format=webp&quality=lossless&width=1424&height=800" alt="Riverra Gathering" />
              <div className="img-overlay">
                <div className="overlay-inner">
            ...
            <div 
              ...
              style={{ flex: "1 1 240px", maxWidth: "280px", cursor: "pointer" }}
              onClick={() => setSelectedImg({
                src: "https://media.discordapp.net/attachments/1255208300006477844/1383074014414639265/Screenshot_2025-06-13_194208.png?ex=6a519acd&is=6a50494d&hm=70e2df15b42be64494c4cb561b2759383cf9d15dfdd8ae3896ce4ecdac4adfef&=&format=webp&quality=lossless&width=1424&height=800",
                title: "SPECIAL MOMENTS",
                cat: "SHARED HAPPINESS"
              })}
            >
              <img src="https://media.discordapp.net/attachments/1255208300006477844/1383074014414639265/Screenshot_2025-06-13_194208.png?ex=6a519acd&is=6a50494d&hm=70e2df15b42be64494c4cb561b2759383cf9d15dfdd8ae3896ce4ecdac4adfef&=&format=webp&quality=lossless&width=1424&height=800" alt="Riverra Fleet" />
              <div className="img-overlay">
                <div className="overlay-inner">
            ...
            <div 
              ...
              style={{ flex: "1 1 240px", maxWidth: "280px", cursor: "pointer" }}
              onClick={() => setSelectedImg({
                src: "https://media.discordapp.net/attachments/1255208300006477844/1426820148609683566/image.png?ex=6a513b10&is=6a4fe990&hm=735aa843aa19c0ace9f3029247c447a5ce86ce65a67eb25adfb9a1d86624abda&=&format=webp&quality=lossless&width=1424&height=800",
                title: "FAMILY REUNION",
                cat: "One Family, One Legacy"
              })}
            >
              <img src="https://media.discordapp.net/attachments/1255208300006477844/1426820148609683566/image.png?ex=6a513b10&is=6a4fe990&hm=735aa843aa19c0ace9f3029247c447a5ce86ce65a67eb25adfb9a1d86624abda&=&format=webp&quality=lossless&width=1424&height=800" alt="Riverra Base" />
              <div className="img-overlay">
                <div className="overlay-inner">
